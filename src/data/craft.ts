...
export const craftPieces: CraftPiece[] = [
  ...
  {
    name: "OatFi",
    kind: "Fintech sales enablement, 2023",
    favicon: "/images/home/oatfi.svg",
    note: "A digital whitepaper I designed for OatFi's sales and marketing team — a structured, brand-led document built to support enterprise conversations and move deals forward. Full layout, type system, and visual language from scratch.",
    panelBg: "linear-gradient(to right, #341872, #1E0D4A)",
    images: [
      { src: "/images/projects/visual/oatfi/converted/Cover.png", alt: "OatFi whitepaper cover", orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/01.png",    alt: "OatFi whitepaper page 1",  orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/02.png",    alt: "OatFi whitepaper page 2",  orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/03.png",    alt: "OatFi whitepaper page 3",  orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/04.png",    alt: "OatFi whitepaper page 4",  orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/05.png",    alt: "OatFi whitepaper page 5",  orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/07.png",    alt: "OatFi whitepaper page 7",  orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/07.2.png",  alt: "OatFi whitepaper page 7b", orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/8.png",     alt: "OatFi whitepaper page 8",  orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/9.png",     alt: "OatFi whitepaper page 9",  orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/10.png",    alt: "OatFi whitepaper page 10", orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/11.png",    alt: "OatFi whitepaper page 11", orientation: "desktop" },
      { src: "/images/projects/visual/oatfi/converted/12.png",    alt: "OatFi whitepaper page 12", orientation: "desktop" },
    ],
  },
  {
    name: "Academia Nauta",
