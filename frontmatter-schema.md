...
| `heroLogo` | path | Small logo above the `<h1>`, natural aspect ratio. Wrapped in a link to `companyUrl` when that field is set (same destination as the Company row link) |
